...
function options() {
  return { global: { stubs: { SettingsApi: Page, SettingsSearch: Page, SettingsTts: Page, CharacterManager: Page, SettingsGeneral: true, SettingsPrivacy: true, SettingsAbout: true, DevPanel: true } } }
}
