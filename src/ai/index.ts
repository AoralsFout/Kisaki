 ...
 * AI 模块 - 统一导出
 */
export { chat, quickChat, supportsStructuredOutput, supportsJsonMode, getBilingualResponseFormat, loadConfig, saveConfig, saveConfigSecure, loadConfigSecure, isConfigValid, DEFAULT_CONFIG } from './client'
