...
export default {
  ...
  app: {
    toolbar: {
      ...
      characterLocked: 'This conversation has messages. Start a new conversation to switch characters.',
      voice: 'Voice on',
      mute: 'Mute',
    ...
    confirm: {
      ...
      screen: {
        ...
        cursorMonitor: 'Capture the monitor containing the pointer',
        primaryMonitor: 'Capture the primary monitor',
        hideKisaki: 'Kisaki will be hidden briefly while capturing',
        includeKisaki: 'The Kisaki window will be included',
        privacy: 'The screenshot may contain other apps, notifications, or private information. Make sure this screen is safe to share with the AI.',
      },
    },
    execution: {
  ...
  settings: {
    ...
    api: {
      ...
      apiKey: 'API Key',
      model: 'Model',
      translationModel: 'Translation and speech-cleanup model (optional)',
      translationModelHint: 'Use a faster compatible model for fallback translation, or leave blank to use the main model.',
    ...
    tts: {
      ...
      preflightMissingApiKey: 'CosyVoice has no API key, so speech will not play.',
      preflightMissingWorkspaceId: 'The Singapore region requires a WorkspaceId before speech can play.',
    ...
    permissions: {
      ...
      screenCaptureTitle: 'Allow AI screen capture requests',
      screenCaptureDesc: 'Lets the AI request a screenshot. Every capture still needs separate confirmation; images stay in memory and are not saved to disk. Off by default.',
    ...
    context: {
      ...
      desc: 'View a snapshot of saved messages, system instructions, tool definitions, and context budget.',
      sessionLabel: 'View session',
      followCurrent: 'Return to current session',
      justNow: 'Updated just now',
      secondsAgo: '{n}s ago',
      nonRealtime: 'Not live',
      nonRealtimeNote: 'This page does not update during a conversation. After a turn finishes, select “Refresh snapshot” to load the latest saved content.',
      refresh: 'Refresh snapshot',
      refreshing: 'Refreshing',
      notConfigured: 'No model configured',
      emptyContent: 'No text content',
      source: { current: 'Current session snapshot', saved: 'Saved snapshot' },
      snapshotNote: {
        saved: 'This is a persisted snapshot. The system prompt and tool definitions are not stored; tool arguments and long content may be redacted or compressed.',
      },
      metrics: { messages: 'protocol messages', tools: 'tools', summaries: 'rounds summarized', pruned: 'messages pruned' },
      search: 'Search content, tool names, call IDs, or arguments…',
      filterLabel: 'Filter by context source',
      filters: { all: 'All', system: 'System', user: 'User', assistant: 'Assistant', tool: 'Results', definition: 'Tool definitions', meta: 'Overview' },
      listLabel: 'Context content list',
      noResults: 'No matching context',
      noSessions: 'No sessions to inspect',
      roles: { system: 'System instruction', user: 'User message', assistant: 'Assistant message', tool: 'Tool result', summary: 'Rolling summary', definition: 'Tool definition' },
      origin: { system: 'First in every request', summary: 'Compressed from earlier conversation', history: 'Active protocol history' },
      toolCalls: '{n} tool calls',
      toolResult: 'Call result · {id}',
      meta: {
        request: 'Request environment', budget: 'Context budget', runtime: 'Runtime status',
        budgetSummary: '{messages} messages · {tools} tools · {summarized} summarized rounds',
      },
      runtime: {
        processing: 'Generating or running tools', idle: 'Idle',
        pending: 'Awaiting confirmation: {name}', activityCount: '{n} tool activities this turn',
      },
      drawerTitle: 'Context details',
      copy: 'Copy JSON',
      copied: 'Copied',
      detail: { kind: 'Type', tokens: 'Estimated tokens', updated: 'Captured' },
    },
    ...
    diagnostics: {
      ...
      logsHint: 'Logs stay on this device. Review them for private data before exporting.',
      sensitiveTitle: 'Sensitive diagnostics',
      sensitiveDesc: 'Allow chat excerpts, voice text, translation input/output, tool arguments, and relative paths in logs. Off by default; enable only while troubleshooting.',
      retentionTitle: 'Log retention',
      retentionDesc: 'Automatically delete diagnostic logs older than {days} days.',
    },
  ...
  logs: {
    ...
    exportPrivacyWarning: 'Diagnostic logs may contain chat content, file names, or local environment details. Review and export them?',
